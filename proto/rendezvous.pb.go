...
func (*ConnectReply) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1} }

func (m *ConnectReply) GetPublicAddr() *Addr {
	if m != nil {
		return m.PublicAddr
	}
	return nil
...
func (m *ConnectReply) GetPrivateAddrs() []*Addr {
	if m != nil {
		return m.PrivateAddrs
	}
	return nil
...
type PublishRequest struct {
	// PrivateAddrs describes source privare addresses.
	PrivateAddrs []*Addr `protobuf:"bytes,1,rep,name=privateAddrs" json:"privateAddrs,omitempty"`
}

func (m *PublishRequest) Reset()                    { *m = PublishRequest{} }
func (m *PublishRequest) String() string            { return proto.CompactTextString(m) }
func (*PublishRequest) ProtoMessage()               {}
func (*PublishRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }
...
type PublishReply struct {
	...
	// PublicAddr is a public network address of a target.
	PublicAddr *Addr `protobuf:"bytes,2,opt,name=publicAddr" json:"publicAddr,omitempty"`
	// PrivateAddrs describes private network addresses of a target.
	//
	// These addresses should be used to perform an initial connection
	// attempt for cases where both peers are located under the same NAT.
...
func (*PublishReply) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{3} }

func (m *PublishReply) GetProtocol() string {
	if m != nil {
		return m.Protocol
	}
	return ""
...
func (m *PublishReply) GetPublicAddr() *Addr {
	if m != nil {
		return m.PublicAddr
	}
	return nil
...
func (m *PublishReply) GetPrivateAddrs() []*Addr {
	if m != nil {
		return m.PrivateAddrs
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ConnectReply)(nil), "sonm.ConnectReply")
	proto.RegisterType((*PublishRequest)(nil), "sonm.PublishRequest")
	proto.RegisterType((*PublishReply)(nil), "sonm.PublishReply")
}
...
type RendezvousClient interface {
	Resolve(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (*ConnectReply, error)
...
func (c *rendezvousClient) Resolve(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (*ConnectReply, error) {
...
func (c *rendezvousClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishReply, error) {
...
type RendezvousServer interface {
	Resolve(context.Context, *ConnectRequest) (*ConnectReply, error)
	// Publish allows to publish the caller server's endpoints.
	//
	// While published the server can be located using the ID extracted from
	// the transport credentials.
...
var fileDescriptor13 = []byte{
	...
	,
}
